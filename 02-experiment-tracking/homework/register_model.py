...
def train_and_log_model(data_path, params):
    ...
    with mlflow.start_run() as run:
        ...
        # Salva o modelo no tracking server
...
def run_register_model(data_path: str, top_n: int):
    ...
    # Pega os top N melhores da otimização
    ...
    # Avalia os top N modelos e registra suas métricas no novo experimento
    for run in hpo_runs:
        train_and_log_model(data_path=data_path, params=run.data.params)

    # Busca a execução com menor test_rmse no novo experimento
    ...
    # Pega o run_id e registra o modelo
    ...
    print(f"✅ Modelo registrado: {REGISTERED_MODEL_NAME} (run_id: {best_run_id})")
